...
void expect_parsed_cmdline_args_matches(int argc, char **argv, bool expected_result, const struct flutter_drm_embedder_cmdline_args expected) {
    struct flutter_drm_embedder_cmdline_args actual;
    bool result;

    result = flutter_drm_embedder_parse_cmdline_args(argc, argv, &actual);
...
static struct flutter_drm_embedder_cmdline_args get_default_args() {
    static char *engine_argv[1] = { "flutter-drm-embedder" };

    return (struct flutter_drm_embedder_cmdline_args){
...
void test_parse_orientation_arg() {
    struct flutter_drm_embedder_cmdline_args expected = get_default_args();
...
void test_parse_rotation_arg() {
    ...
    expected.rotation = 0;
    expect_parsed_cmdline_args_matches(4, (char *[]){ "flutter-drm-embedder", "--rotation", "0", BUNDLE_PATH }, true, expected);

    expected.rotation = 90;
    expect_parsed_cmdline_args_matches(4, (char *[]){ "flutter-drm-embedder", "--rotation", "90", BUNDLE_PATH }, true, expected);

    expected.rotation = 180;
    expect_parsed_cmdline_args_matches(4, (char *[]){ "flutter-drm-embedder", "--rotation", "180", BUNDLE_PATH }, true, expected);

    expected.rotation = 270;
    expect_parsed_cmdline_args_matches(4, (char *[]){ "flutter-drm-embedder", "--rotation", "270", BUNDLE_PATH }, true, expected);
}
...
void test_parse_physical_dimensions_arg() {
    ...
    expect_parsed_cmdline_args_matches(4, (char *[]){ "flutter-drm-embedder", "--dimensions", "-10,-10", BUNDLE_PATH }, false, expected);
    expect_parsed_cmdline_args_matches(4, (char *[]){ "flutter-drm-embedder", "--dimensions", "xyz", BUNDLE_PATH }, false, expected);

    expected = get_default_args();
    expected.has_physical_dimensions = true;
    expected.physical_dimensions = (struct vec2i){ .x = 10, .y = 10 };
    expect_parsed_cmdline_args_matches(4, (char *[]){ "flutter-drm-embedder", "--dimensions", "10,10", BUNDLE_PATH }, true, expected);
}
...
void test_parse_pixel_format_arg() {
    ...
    expect_parsed_cmdline_args_matches(4, (char *[]){ "flutter-drm-embedder", "--pixelformat", "RGB565", BUNDLE_PATH }, true, expected);

    expected.pixel_format = PIXFMT_RGBA8888;
    expect_parsed_cmdline_args_matches(4, (char *[]){ "flutter-drm-embedder", "--pixelformat", "RGBA8888", BUNDLE_PATH }, true, expected);
}
...
void test_parse_runtime_mode_arg() {
    ...
    expected.engine_argc = 0;
    expected.engine_argv = NULL;
    expect_parsed_cmdline_args_matches(3, (char *[]){ "flutter-drm-embedder", "--debug", BUNDLE_PATH }, false, expected);

    expected = get_default_args();
    expected.has_runtime_mode = true;
    expected.runtime_mode = FLUTTER_RUNTIME_MODE_PROFILE;
    expect_parsed_cmdline_args_matches(3, (char *[]){ "flutter-drm-embedder", "--profile", BUNDLE_PATH }, true, expected);

    expected.runtime_mode = FLUTTER_RUNTIME_MODE_RELEASE;
    expect_parsed_cmdline_args_matches(3, (char *[]){ "flutter-drm-embedder", "--release", BUNDLE_PATH }, true, expected);
}
...
void test_parse_bundle_path_arg() {
    ...
    expect_parsed_cmdline_args_matches(2, (char *[]){ "flutter-drm-embedder", "/path/to/bundle/test" }, true, expected);
}
...
void test_parse_engine_arg() {
    ...
    expected.engine_argv = (char *[]){ "flutter-drm-embedder", "engine-arg" };

    expect_parsed_cmdline_args_matches(3, (char *[]){ "flutter-drm-embedder", BUNDLE_PATH, "engine-arg" }, true, expected);
}
...
void test_parse_vulkan_arg() {
    ...
    expect_parsed_cmdline_args_matches(3, (char *[]){ "flutter-drm-embedder", "--vulkan", BUNDLE_PATH }, true, expected);
}
...
void test_parse_desired_videomode_arg() {
    ...
    expect_parsed_cmdline_args_matches(4, (char *[]){ "flutter-drm-embedder", "--videomode", "1920x1080", BUNDLE_PATH }, true, expected);

    expected.desired_videomode = "1920x1080@60";
    expect_parsed_cmdline_args_matches(4, (char *[]){ "flutter-drm-embedder", "--videomode", "1920x1080@60", BUNDLE_PATH }, true, expected);
}
