...
static int on_register_texture(void *userdata, int64_t texture_identifier) {
    ...
    LOG_DEBUG("[embedder] RegisterExternalTexture id=%" PRId64 "\n", texture_identifier);
    ...
    LOG_DEBUG("[embedder] RegisterExternalTexture id=%" PRId64 " succeeded\n", texture_identifier);
    return 0;
}
...
static int on_unregister_texture(void *userdata, int64_t texture_identifier) {
    ...
    LOG_DEBUG("[embedder] UnregisterExternalTexture id=%" PRId64 "\n", texture_identifier);
    ...
    LOG_DEBUG("[embedder] UnregisterExternalTexture id=%" PRId64 " succeeded\n", texture_identifier);
    return 0;
}
