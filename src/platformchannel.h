...
#define STDVALUE_IS_INT_ARRAY(value) \
    (((value).type == kStdInt32Array) || ((value).type == kStdInt64Array) || ((value).type == kStdUInt8Array))
...
#define STDMAP2(key1, val1, key2, val2) \
    ((struct std_value                  \
    ){ .type = kStdMap, .size = 2, .keys = (struct std_value[2]){ (key1), (key2) }, .values = (struct std_value[2]){ (val1), (val2) } })
#define STDMAP3(key1, val1, key2, val2, key3, val3)                               \
    ((struct std_value){ .type = kStdMap,                                         \
                         .size = 3,                                               \
                         .keys = (struct std_value[3]){ (key1), (key2), (key3) }, \
                         .values = (struct std_value[3]){ (val1), (val2), (val3) } })
#define STDMAP4(key1, val1, key2, val2, key3, val3, key4, val4)                           \
    ((struct std_value){ .type = kStdMap,                                                 \
                         .size = 4,                                                       \
                         .keys = (struct std_value[4]){ (key1), (key2), (key3), (key4) }, \
                         .values = (struct std_value[4]){ (val1), (val2), (val3), (val4) } })
#define STDMAP5(key1, val1, key2, val2, key3, val3, key4, val4, key5, val5)                       \
    ((struct std_value){ .type = kStdMap,                                                         \
                         .size = 5,                                                               \
                         .keys = (struct std_value[5]){ (key1), (key2), (key3), (key4), (key5) }, \
                         .values = (struct std_value[5]){ (val1), (val2), (val3), (val4), (val5) } })
#define STDMAP6(key1, val1, key2, val2, key3, val3, key4, val4, key5, val5, key6, val6)                   \
    ((struct std_value){ .type = kStdMap,                                                                 \
                         .size = 6,                                                                       \
                         .keys = (struct std_value[6]){ (key1), (key2), (key3), (key4), (key5), (key6) }, \
                         .values = (struct std_value[6]){ (val1), (val2), (val3), (val4), (val5), (val6) } })
#define STDMAP7(key1, val1, key2, val2, key3, val3, key4, val4, key5, val5, key6, val6, key7, val7)               \
    ((struct std_value){ .type = kStdMap,                                                                         \
                         .size = 7,                                                                               \
                         .keys = (struct std_value[7]){ (key1), (key2), (key3), (key4), (key5), (key6), (key7) }, \
                         .values = (struct std_value[7]){ (val1), (val2), (val3), (val4), (val5), (val6), (val7) } })
#define STDMAP8(key1, val1, key2, val2, key3, val3, key4, val4, key5, val5, key6, val6, key7, val7, key8, val8)           \
    ((struct std_value){ .type = kStdMap,                                                                                 \
                         .size = 8,                                                                                       \
                         .keys = (struct std_value[8]){ (key1), (key2), (key3), (key4), (key5), (key6), (key7), (key8) }, \
                         .values = (struct std_value[8]){ (val1), (val2), (val3), (val4), (val5), (val6), (val7), (val8) } })
#define STDMAP9(key1, val1, key2, val2, key3, val3, key4, val4, key5, val5, key6, val6, key7, val7, key8, val8, key9, val9)       \
    ((struct std_value){ .type = kStdMap,                                                                                         \
                         .size = 9,                                                                                               \
                         .keys = (struct std_value[9]){ (key1), (key2), (key3), (key4), (key5), (key6), (key7), (key8), (key9) }, \
                         .values = (struct std_value[9]){ (val1), (val2), (val3), (val4), (val5), (val6), (val7), (val8), (val9) } })
#define STDMAP10(key1, val1, key2, val2, key3, val3, key4, val4, key5, val5, key6, val6, key7, val7, key8, val8, key9, val9, key10, val10) \
    ((struct std_value                                                                                                                     \
    ){ .type = kStdMap,                                                                                                                    \
       .size = 10,                                                                                                                         \
       .keys = (struct std_value[10]){ (key1), (key2), (key3), (key4), (key5), (key6), (key7), (key8), (key9), (key10) },                  \
       .values = (struct std_value[10]){ (val1), (val2), (val3), (val4), (val5), (val6), (val7), (val8), (val9), (val10) } })
#define STDMAP11(                                                                                                                  \
    key1,                                                                                                                          \
    val1,                                                                                                                          \
    key2,                                                                                                                          \
    ...
    ((struct std_value                                                                                                             \
       ...
       .size = 11,                                                                                                                 \
       .keys = (struct std_value[11]){ (key1), (key2), (key3), (key4), (key5), (key6), (key7), (key8), (key9), (key10), (key11) }, \
       .values = (struct std_value[11]){ (val1), (val2), (val3), (val4), (val5), (val6), (val7), (val8), (val9), (val10), (val11) } })
#define STDMAP12(                                                                                                                \
    key1,                                                                                                                        \
    val1,                                                                                                                        \
    key2,                                                                                                                        \
...
#define STDMAP16(                                                   \
    ...
    ((struct std_value){ .type = kStdMap,                           \
                         ...
                         .keys = (struct std_value[16]){ (key1),    \
                                                         ...
                                                         (key15),   \
                                                         (key16) }, \
                         .values = (struct std_value[16]){ (val1),  \
                                                           (val2),  \
                                                           (val3),  \
                                                           (val4),  \
                                                           (val5),  \
...
#define STDMAP17(                                                   \
    ...
    ((struct std_value){ .type = kStdMap,                           \
                         ...
                         .keys = (struct std_value[17]){ (key1),    \
                                                         ...
                                                         (key16),   \
                                                         (key17) }, \
                         .values = (struct std_value[17]){ (val1),  \
                                                           (val2),  \
                                                           (val3),  \
                                                           (val4),  \
                                                           (val5),  \
...
#define STDMAP18(                                                   \
    ...
    ((struct std_value){ .type = kStdMap,                           \
                         ...
                         .keys = (struct std_value[18]){ (key1),    \
                                                         ...
                                                         (key17),   \
                                                         (key18) }, \
                         .values = (struct std_value[18]){ (val1),  \
                                                           (val2),  \
                                                           (val3),  \
                                                           (val4),  \
                                                           (val5),  \
...
#define STDMAP19(                                                   \
    ...
    ((struct std_value){ .type = kStdMap,                           \
                         ...
                         .keys = (struct std_value[19]){ (key1),    \
                                                         ...
                                                         (key18),   \
                                                         (key19) }, \
                         .values = (struct std_value[19]){ (val1),  \
                                                           (val2),  \
                                                           (val3),  \
                                                           (val4),  \
                                                           (val5),  \
...
#define STDMAP20(                                                                                                                  \
    ...
    ((struct std_value                                                                                                             \
       ...
       .size = 20,                                                                                                                 \
       .keys = (struct std_value[20]){ (key1),  (key2),  (key3),  (key4),  (key5),  (key6),  (key7),  (key8),  (key9),  (key10),   \
                                       (key11), (key12), (key13), (key14), (key15), (key16), (key17), (key18), (key19), (key20) }, \
       .values = (struct std_value[20]){ (val1),  (val2),  (val3),  (val4),  (val5),  (val6),  (val7),  (val8),  (val9),  (val10), \
                                         (val11), (val12), (val13), (val14), (val15), (val16), (val17), (val18), (val19), (val20) } })

#define STDLIST1(val1) ((struct std_value){ .type = kStdList, .size = 1, .list = (struct std_value[1]){ (val1) } })

#define STDLIST2(val1, val2) ((struct std_value){ .type = kStdList, .size = 2, .list = (struct std_value[2]){ (val1), (val2) } })
...
#define JSONARRAY1(val1) ((struct json_value){ .type = kJsonArray, .size = 1, .array = (struct json_value[1]){ (val1) } })
#define JSONARRAY2(val1, val2) ((struct json_value){ .type = kJsonArray, .size = 2, .array = (struct json_value[2]){ (val1), (val2) } })
#define JSONARRAY3(val1, val2, val3) \
    ((struct json_value){ .type = kJsonArray, .size = 3, .array = (struct json_value[3]){ (val1), (val2), (val3) } })

#define JSONOBJECT1(key1, val1) \
    ((struct json_value){ .type = kJsonObject, .size = 1, .keys = (char *[1]){ (key1) }, .values = (struct json_value[1]){ (val1) } })

#define JSONOBJECT2(key1, val1, key2, val2) \
    ((struct json_value                     \
    ){ .type = kJsonObject, .size = 2, .keys = (char *[2]){ (key1), (key2) }, .values = (struct json_value[2]){ (val1), (val2) } })
#define JSONOBJECT3(key1, val1, key2, val2, key3, val3)                  \
    ((struct json_value){ .type = kJsonObject,                           \
                          .size = 3,                                     \
                          .keys = (char *[3]){ (key1), (key2), (key3) }, \
                          .values = (struct json_value[3]){ (val1), (val2), (val3) } })
#define JSONOBJECT4(key1, val1, key2, val2, key3, val3, key4, val4)              \
    ((struct json_value){ .type = kJsonObject,                                   \
                          .size = 4,                                             \
                          .keys = (char *[4]){ (key1), (key2), (key3), (key4) }, \
                          .values = (struct json_value[4]){ (val1), (val2), (val3), (val4) } })
#define JSONOBJECT5(key1, val1, key2, val2, key3, val3, key4, val4, key5, val5)          \
    ((struct json_value){ .type = kJsonObject,                                           \
                          .size = 5,                                                     \
                          .keys = (char *[5]){ (key1), (key2), (key3), (key4), (key5) }, \
                          .values = (struct json_value[5]){ (val1), (val2), (val3), (val4), (val5) } })
#define JSONOBJECT6(key1, val1, key2, val2, key3, val3, key4, val4, key5, val5, key6, val6)      \
    ((struct json_value){ .type = kJsonObject,                                                   \
                          .size = 6,                                                             \
                          .keys = (char *[6]){ (key1), (key2), (key3), (key4), (key5), (key6) }, \
                          .values = (struct json_value[6]){ (val1), (val2), (val3), (val4), (val5), (val6) } })
#define JSONOBJECT7(key1, val1, key2, val2, key3, val3, key4, val4, key5, val5, key6, val6, key7, val7)  \
    ((struct json_value){ .type = kJsonObject,                                                           \
                          .size = 7,                                                                     \
                          .keys = (char *[7]){ (key1), (key2), (key3), (key4), (key5), (key6), (key7) }, \
                          .values = (struct json_value[7]){ (val1), (val2), (val3), (val4), (val5), (val6), (val7) } })
#define JSONOBJECT8(key1, val1, key2, val2, key3, val3, key4, val4, key5, val5, key6, val6, key7, val7, key8, val8) \
    ((struct json_value){ .type = kJsonObject,                                                                      \
                          .size = 8,                                                                                \
                          .keys = (char *[8]){ (key1), (key2), (key3), (key4), (key5), (key6), (key7), (key8) },    \
                          .values = (struct json_value[8]){ (val1), (val2), (val3), (val4), (val5), (val6), (val7), (val8) } })
#define JSONOBJECT9(key1, val1, key2, val2, key3, val3, key4, val4, key5, val5, key6, val6, key7, val7, key8, val8, key9, val9) \
    ((struct json_value){ .type = kJsonObject,                                                                                  \
                          .size = 9,                                                                                            \
                          .keys = (char *[9]){ (key1), (key2), (key3), (key4), (key5), (key6), (key7), (key8), (key9) },        \
                          .values = (struct json_value[9]){ (val1), (val2), (val3), (val4), (val5), (val6), (val7), (val8), (val9) } })
#define JSONOBJECT10(key1, val1, key2, val2, key3, val3, key4, val4, key5, val5, key6, val6, key7, val7, key8, val8, key9, val9, key10, val10) \
    ((struct json_value                                                                                                                        \
    ){ .type = kJsonObject,                                                                                                                    \
       .size = 10,                                                                                                                             \
       .keys = (char *[10]){ (key1), (key2), (key3), (key4), (key5), (key6), (key7), (key8), (key9), (key10) },                                \
       .values = (struct json_value[10]){ (val1), (val2), (val3), (val4), (val5), (val6), (val7), (val8), (val9), (val10) } })
#define JSONOBJECT11(                                                                                                    \
    key1,                                                                                                                \
    val1,                                                                                                                \
    key2,                                                                                                                \
    ...
    ((struct json_value                                                                                                  \
       ...
       .size = 11,                                                                                                       \
       .keys = (char *[11]){ (key1), (key2), (key3), (key4), (key5), (key6), (key7), (key8), (key9), (key10), (key11) }, \
       .values = (struct json_value[11]){ (val1), (val2), (val3), (val4), (val5), (val6), (val7), (val8), (val9), (val10), (val11) } })
#define JSONOBJECT12(                                                                                                             \
    key1,                                                                                                                         \
    val1,                                                                                                                         \
    key2,                                                                                                                         \
    ...
    ((struct json_value                                                                                                           \
       ...
       .size = 12,                                                                                                                \
       .keys = (char *[12]){ (key1), (key2), (key3), (key4), (key5), (key6), (key7), (key8), (key9), (key10), (key11), (key12) }, \
...
#define JSONOBJECT13(                                                                                                                      \
    ...
    ((struct json_value                                                                                                                    \
       ...
       .size = 13,                                                                                                                         \
       .keys = (char *[13]){ (key1), (key2), (key3), (key4), (key5), (key6), (key7), (key8), (key9), (key10), (key11), (key12), (key13) }, \
...
#define JSONOBJECT16(                                                 \
    ...
    ((struct json_value){ .type = kJsonObject,                        \
                          ...
                          .keys = (char *[16]){ (key1),               \
                                                ...
                                                (key15),              \
                                                (key16) },            \
                          .values = (struct json_value[16]){ (val1),  \
                                                             (val2),  \
                                                             (val3),  \
                                                             (val4),  \
                                                             (val5),  \
...
#define JSONOBJECT17(                                                 \
    ...
    ((struct json_value){ .type = kJsonObject,                        \
                          ...
                          .keys = (char *[17]){ (key1),               \
                                                ...
                                                (key16),              \
                                                (key17) },            \
                          .values = (struct json_value[17]){ (val1),  \
                                                             (val2),  \
                                                             (val3),  \
                                                             (val4),  \
                                                             (val5),  \
...
#define JSONOBJECT18(                                                 \
    ...
    ((struct json_value){ .type = kJsonObject,                        \
                          ...
                          .keys = (char *[18]){ (key1),               \
                                                ...
                                                (key17),              \
                                                (key18) },            \
                          .values = (struct json_value[18]){ (val1),  \
                                                             (val2),  \
                                                             (val3),  \
                                                             (val4),  \
                                                             (val5),  \
...
#define JSONOBJECT19(                                                 \
    ...
    ((struct json_value){ .type = kJsonObject,                        \
                          ...
                          .keys = (char *[19]){ (key1),               \
                                                ...
                                                (key18),              \
                                                (key19) },            \
                          .values = (struct json_value[19]){ (val1),  \
                                                             (val2),  \
                                                             (val3),  \
                                                             (val4),  \
                                                             (val5),  \
...
#define JSONOBJECT20(                                                                                                               \
    ...
    ((struct json_value                                                                                                             \
       ...
       .size = 20,                                                                                                                  \
       .keys = (char *[20]){ (key1),  (key2),  (key3),  (key4),  (key5),  (key6),  (key7),  (key8),  (key9),  (key10),              \
                             (key11), (key12), (key13), (key14), (key15), (key16), (key17), (key18), (key19), (key20) },            \
       .values = (struct json_value[20]){ (val1),  (val2),  (val3),  (val4),  (val5),  (val6),  (val7),  (val8),  (val9),  (val10), \
                                          (val11), (val12), (val13), (val14), (val15), (val16), (val17), (val18), (val19), (val20) } })
...
#define PLATCH_OBJ_BINARY_DATA(data, data_size) \
    ((struct platch_obj){ .codec = kBinaryCodec, .binarydata_size = (data_size), .binarydata = (data) })
...
#define PLATCH_OBJ_STD_CALL(method_name, arg) \
    ((struct platch_obj){ .codec = kStandardMethodCall, .method = (char *) (method_name), .std_arg = (arg) })
#define PLATCH_OBJ_JSON_CALL(method_name, arg) \
    ((struct platch_obj){ .codec = kJSONMethodCall, .method = (char *) (method_name), .json_arg = (arg) })
#define PLATCH_OBJ_STD_CALL_SUCCESS_RESPONSE(result) \
    ((struct platch_obj){ .codec = kStandardMethodCallResponse, .success = true, .std_result = (result) })
#define PLATCH_OBJ_STD_CALL_ERROR_RESPONSE(code, msg, details)  \
    ((struct platch_obj){ .codec = kStandardMethodCallResponse, \
                          .success = false,                     \
                          .error_code = (char *) (code),        \
                          .error_msg = (char *) (msg),          \
                          .std_error_details = (details) })
#define PLATCH_OBJ_JSON_CALL_SUCCESS_RESPONSE(result) \
    ((struct platch_obj){ .codec = kJSONMethodCallResponse, .success = true, .json_result = (result) })
#define PLATCH_OBJ_JSON_CALL_ERROR_RESPONSE(code, msg, details) \
    ((struct platch_obj){ .codec = kStandardMethodCallResponse, \
                          .success = false,                     \
                          .error_code = (char *) (code),        \
                          .error_msg = (char *) (msg),          \
                          .json_error_details = (details) })
...
#define for_each_entry_in_raw_std_map_indexed(index, key, value, map)                                                        \
    for (const struct raw_std_value *key = raw_std_map_get_first_key(map), *value = raw_std_value_after(key), *guard = NULL; \
         guard == NULL;                                                                                                      \
         guard = (void *) 1)                                                                                                 \
        for (size_t index = 0; index < raw_std_map_get_size(map); index++,                                                   \
...
#define for_each_element_in_raw_std_list_indexed(index, element, list)                                                                 \
    for (const struct raw_std_value *element = raw_std_list_get_first_element(list), *guard = NULL; guard == NULL; guard = (void *) 1) \
        for (size_t index = 0; index < raw_std_list_get_size(list);                                                                    \
             index++, element = (index) < raw_std_list_get_size(list) ? raw_std_value_after(element) : NULL)
